...
export class ShippingAddressService {
  ...
  async createCancelOrders(
    ...
    const createCancelOrders = new this.shippingAddressModel(
      shippingAddressDto,
    );
  ...
  async updateById(
    id: string,
    updateShippingAddressDto: ShippingAddressDto,
  ): Promise<ShippingAddressDocument> {
    const updatedShippingAddress = await this.shippingAddressModel
