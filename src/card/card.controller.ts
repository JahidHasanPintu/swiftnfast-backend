...
export class CardController {
  ...
  @Post()
  async create(
    @Body() createCardBeneficiaryDto: CreateCardBeneficiaryDto,
  ...
  async getCardBeneficiariesByCardType(
    ...
    return this.createCardBeneficiaryService.getCardBeneficiariesByCardType(
      cardType,
    );
  }
  ...
  async updateCardBeneficiary(
    ...
    return this.createCardBeneficiaryService.updateCardBeneficiary(
      cardNumber,
      updateDto,
    );
  }
